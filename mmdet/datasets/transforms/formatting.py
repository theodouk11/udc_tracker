...
class PackDetInputsForTTA(BaseTransform):
    """Pack the input data for TTA (inference only).

    Args:
        meta_keys (Sequence[str], optional): Meta keys to be converted to
            DetDataSample metainfo. Default includes TTA-specific keys.
    """
    def __init__(self,
                 meta_keys=('img_id', 'img_path', 'ori_shape', 'img_shape',
                            'scale_factor', 'flip', 'flip_direction',
                            'crop_offset', 'crop_size', 'resize_scale', 'brightness_factor')):
        self.meta_keys = meta_keys

    def transform(self, results: dict) -> dict:
        """Pack the input data for TTA.
        ...
        Returns:
            dict:
                ...
                - 'data_samples' (DetDataSample): The metainfo for TTA.
        """
        packed_results = dict()
