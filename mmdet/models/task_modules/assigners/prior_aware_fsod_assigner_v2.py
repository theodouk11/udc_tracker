...
class PriorAwareFSODAssigner_v2(BaseAssigner):
    """FSOD Assigner for Few-Shot Object Detection.
    
    This assigner is designed for FSOD scenarios where some positive samples may be unlabeled.
    The Hungarian matching is identical to standard HungarianAssigner, but additionally 
    identifies potential unlabeled positives from background queries.
    
    Key features:
    1. Hungarian matching identical to standard HungarianAssigner
    2. Identify potential unlabeled positives from background queries based on confidence and IoU
    ...
    def assign(
        ...
        **kwargs
        ...
        # Use original cost matrix to ensure matching is identical to standard HungarianAssigner
        ...
        # 6. Detect potential unlabeled positives
        # These are unmatched queries with high confidence but low IoU with GT
