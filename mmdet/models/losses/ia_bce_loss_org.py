...
def py_ia_bce_loss_org(pred,
    ...
    if iou_weighted:
        ...
        loss = neg_weights * pred - torch.nn.functional.logsigmoid(pred) * (pos_weights + neg_weights)
...
class IABCELossOrg(nn.Module):
    ...
    def __init__(self,
        ...
        Args:
            ...
            activated (bool, optional): Whether the input is activated.
                ...
                Defaults to False.
        """
        super(IABCELossOrg, self).__init__()
    ...
    def forward(self,
        ...
        if self.use_sigmoid:
            ...
            loss_cls = self.loss_weight * py_ia_bce_loss_org(
                pred,
                target,
                weight,
                alpha=self.alpha,
